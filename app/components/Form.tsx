...
const Form = () => {
    ...
    return (
        <form className="w-full h-[10%] shadow-2xl">
            <input value={input} placeholder="Create A New Todo" onChange={(e) => { setInput(e.target.value) }} type="text" className="w-full h-full ps-[72px] py-10 focus:outline-none rounded-md dark:bg-[#25273c] bg-white shadow-2xl dark:text-white text-lg" />
