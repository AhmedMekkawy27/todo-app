...
const Login = () => {
    ...
    return (
        <div className="flex justify-center items-center dark:bg-[#181824] w-screen h-screen">
            <div className="w-[50%] h-[50%] flex justify-center items-center">
                <form action="" className="flex flex-col justify-between gap-8">
                    ...
                    <button type="submit" onClick={handleSubmit} className="bg-slate-900 text-white py-2 rounded-md">Submit</button>
                </form>
            </div>
        </div>
    )
